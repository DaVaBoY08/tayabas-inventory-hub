...
const navigation = [
  ...
  { name: "Bulk Receiving", href: "/bulk-receiving", icon: Layers },
  { name: "Stock Issuance", href: "/issuance", icon: PackageMinus },
  { name: "Bulk Issuance", href: "/bulk-issuance", icon: Layers },
  { name: "Department Requests", href: "/requests", icon: FileInput },
  { name: "Custodians", href: "/custodians", icon: Users },
  { name: "Stock Card", href: "/stock-card", icon: FileText },
  { name: "PAR", href: "/par", icon: FileCheck },
